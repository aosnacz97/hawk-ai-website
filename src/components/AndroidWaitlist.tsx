      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-600 text-center mb-8 leading-relaxed">
            Hawk AI is expanding to Android! Be the first to know when our AI-powered vision improvement 
            and eye exercise app launches on Google Play.
          </p>

          {/* Google Play Badge */}
          <div className="text-center mb-8">
            <a href="#play-store" className="inline-block transition-transform hover:scale-105">
              <Image
                src="/play_store_badge.png"
                alt="Get it on Google Play"
                width={200}
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                We&apos;ll notify you as soon as Hawk AI launches on Android.
              </p>
            </div>
          )}
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Same powerful features as iOS</span>
              </div>
            </div>
          </div>
