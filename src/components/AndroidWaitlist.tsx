      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-600 text-center mb-8 leading-relaxed">
            Ease Up is expanding to Android! Be the first to know when our AI-powered posture correction 
            and pain relief app launches on Google Play.
          </p>
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                We&apos;ll notify you as soon as Ease Up launches on Android.
              </p>
            </div>
          )}
